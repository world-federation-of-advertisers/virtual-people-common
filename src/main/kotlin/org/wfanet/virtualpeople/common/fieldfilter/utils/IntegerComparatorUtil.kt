 ...
 * ```
 *
 * To build an IntegerComparator which compares the field b.c in message A with value 10: comparator
 * = IntegerComparator.new(fieldDescriptors, "10")
 *
 * Compare examples: testProto1 = testProto { a = testProtoA { b = testProtoB { value = 11 } } }
 * IntegerCompareResult result1 = comparator.compare(testProto1); GREATER_THAN
 *
 * testProto2 = testProto { a = testProtoA { b = testProtoB { value = 10 } } } IntegerCompareResult
 * result2 = comparator.compare(testProto2); EQUAL
 *
 * testProto3 = testProto { a = testProtoA { b = testProtoB { value = 9 } } } IntegerCompareResult
 * result3 = comparator.compare(testProto3); LESS_THAN
 */
...
private class IntegerComparatorImpl<ValueType>(
  ...
  override fun compare(messageOrBuilder: MessageOrBuilder): IntegerCompareResult {
    ...
    if (fieldValue.value as Comparable<ValueType> > value) {
