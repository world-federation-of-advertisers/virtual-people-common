...
private val supportedType =
  listOf(Type.INT32, Type.INT64, Type.UINT32, Type.UINT64, Type.BOOL, Type.ENUM, Type.STRING)

/**
 * Convert the protobuf field in @param message represented by fieldDescriptor to a
 * FieldFilterProto, which checks the equality of the given field, or any nested field of the given
 * field.
 */
fun convertFieldToFilter(
  ...
  return fieldFilterProto {
    ...
    } else if (fieldDescriptor.type in supportedType) {
